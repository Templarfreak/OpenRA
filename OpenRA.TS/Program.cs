...
namespace OpenRA
{
	class WindowsLauncher
	{
		...
		const string ModID = "ts-mod";
		const string DisplayName = "Tiberian Sun";
		const string WindowTitle = "\"Tiberian Sun\"";
		...
		static int RunInnerLauncher(string[] args)
		{
			...
			if (!launcherArgs.Any(x => x.StartsWith("WindowName=", StringComparison.Ordinal)))
				launcherArgs.Add("WindowName=" + WindowTitle);
