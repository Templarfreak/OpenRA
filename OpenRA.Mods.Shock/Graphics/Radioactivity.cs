...
namespace OpenRA.Mods.Shock.Graphics
{
	class Radioactivity : IRenderable, IFinalizedRenderable, IEffect
	{
		...
		public void Render(WorldRenderer wr)
		{
			...
			//Manually correct Z's of vertices because something funky is going on with them and Idk what else to do LOL
			var screen1 = new float3(screen[0].X + 0, screen[0].Y, screen[0].Z + 3);
			var screen2 = new float3(screen[1].X + 0, screen[1].Y, screen[1].Z + 4);
			var screen3 = new float3(screen[2].X + 0, screen[2].Y, screen[2].Z + 5);
			var screen4 = new float3(screen[3].X + 0, screen[3].Y, screen[3].Z + 5);
			...
			//Polygon seems to work correctly. Even reacts to Terrain Geometry properly.
			//Only issue is... It only draws an outline.
...
//			*/
//
//			Game.Renderer.WorldRgbaColorRenderer_1.FillTriangle(screen[0], screen[1], screen[2], Color.FromArgb(alpha, layer.Info.Color));
//			Game.Renderer.WorldRgbaColorRenderer_1.FillTriangle(screen[2], screen[3], screen[0], Color.FromArgb(alpha, layer.Info.Color));
//
//			// mix in yellow so that the radion shines brightly, after certain threshold.
//			// It is different than tinting the info.color itself and provides nicer look.
//			if (alpha > layer.Info.MixThreshold)
//			{
//				Game.Renderer.WorldRgbaColorRenderer_1.FillTriangle(screen[0], screen[1], screen[2], Color.FromArgb(16, layer.Info.Color2));
//				Game.Renderer.WorldRgbaColorRenderer_1.FillTriangle(screen[2], screen[3], screen[0], Color.FromArgb(16, layer.Info.Color2));
//			}
//
